...
const Post = ({ post, setCurrentId }) => {
    ...
    return (
        <Box w="sm" h="sm" borderWidth="1px" borderRadius="lg" overflow="hidden" onClick={openPost}>
          <Image h="250" w="100%" src={post.selectedFile || 'https://user-images.githubusercontent.com/194400/49531010-48dad180-f8b1-11e8-8d89-1e61320e1d82.png' } alt={post.name} />
